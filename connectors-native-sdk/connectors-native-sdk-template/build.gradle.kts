...
repositories {
    maven { url = URI("https://artifactory.ci1.us-west-2.aws-dev.app.snowflake.com/artifactory/development-maven-virtual") }
    mavenLocal()
}

dependencies {
    compileOnly("com.snowflake:connectors-native-sdk:2.1.1-SNAPSHOT")
    testImplementation("org.junit.jupiter:junit-jupiter:5.11.3")
    testImplementation("com.snowflake:connectors-native-sdk-test:2.1.1-SNAPSHOT")
}
